...
(function (saisei) {
        ...
        function ImgData() {
            ...
            this.select = function (key) {
                ...
                for (var i = 0; i < _this.imgPathList.length; i++) {
                    var fileName = _this.imgPathList[i].imgpath;
                    var fileInfo = _this.imgPathList[i].imginfo;
            ...
            temp.sort(function (record1, record2) {
                var comp = 0;
    ...
    saisei.imgRecord = new ImgRecord();
})(saisei || (saisei = {}));
